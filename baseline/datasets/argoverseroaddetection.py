...
class ArgoverseRoadDetection:
    def __init__(self, data_root: str , split, mode_item='pillar', description=None, cfg=None , av_hd_map_dir = "/home/ofel04/argoverse-api/map_files/" , max_number_of_log : int = 22) -> None:
